...
class Animal {
    ...
    fun deleteAll(context: Context) {
        try {
            ...
            Toast.makeText(context, "Todos los animales han sido eliminados", Toast.LENGTH_SHORT).show()
        } catch (ex: Exception) {
            Toast.makeText(context, "No se pudo eliminar los animales", Toast.LENGTH_SHORT).show()
        }
    }
